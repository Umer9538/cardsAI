...
class ScanResultScreen extends ConsumerWidget {
  ...
  Future<void> _editItem(
    ...
    final edited = await showModalBottomSheet<_ItemEdit>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => _EditItemSheet(food: food),
    );
...
class _EditItemSheet extends StatefulWidget {
  const _EditItemSheet({required this.food});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 18),
                _SheetField(label: 'Food', controller: _name),
                const SizedBox(height: 14),
                _SheetField(
                  label: 'Weight (g)',
                  controller: _grams,
